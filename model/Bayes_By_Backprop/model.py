...
class Bayes_MLP(BaseModel):
    def __init__(self, input_dim, num_classes, n_hid, prior, activation='ReLU'):
        super().__init__()
        ...
        fc.append(BayesLinear_Normalq(self.n_hid[-1], self.num_classes, self.prior_instance))
...
class Bayes_MLP_LR(BaseModel):
    def __init__(self, input_dim, num_classes, n_hid, prior_sig, activation='ReLU'):
        super().__init__()
        # prior_instance = isotropic_gauss_prior(mu=0, sigma=0.1)
        # prior_instance = spike_slab_2GMM(mu1=0, mu2=0, sigma1=0.135, sigma2=0.001, pi=0.5)
        # prior_instance = isotropic_gauss_prior(mu=0, sigma=0.1)
        ...
        fc.append(BayesLinear_local_reparam(self.n_hid[-1], self.num_classes, prior_sig))
