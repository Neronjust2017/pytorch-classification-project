...
class MLP_dropout(BaseModel):
    def __init__(self, input_dim, num_classes, n_hid, pdrop, activation='ReLU'):
        super().__init__()
        self.input_dim = input_dim
        self.num_classes = num_classes
        self.n_hid = n_hid
...
class CNN(BaseModel):
    def __init__(self, input_dim, num_classes, filters, kernels, activation='ReLU'):
        super().__init__()
        self.input_dim = input_dim
        self.num_classes = num_classes
...
class CNN_dropout(BaseModel):
    def __init__(self, input_dim, num_classes, filters, kernels, pdrop, activation='ReLU'):
        super().__init__()
        self.input_dim = input_dim
        self.num_classes = num_classes
        self.filters = filters
